...
basedir="/n/regal/gabrielse_lab/njones/STD_Pulsed_Cooling_Spectrum_coldest_w_bad_transitions";
...
stddevsurvfn=FileNameJoin[{trapoutdir,"stddev_surv_loc_"<>dettostr[det]<>".bin"}];
BinaryWrite[stddevsurvfn,StandardDeviation[tmp[[survidxs]]]/Sqrt[Length[survidxs]],"Real64"];
Close[stddevsurvfn]
